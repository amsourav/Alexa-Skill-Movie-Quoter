...
const quotes = [{
    ...
    {
        quote: "I am Moana of Motunui. You will board my boat, sail across the ocean, and restore the heart of Te Fiti.",
        movieName: 'Moana',
    },
    {
        quote: "All right, all right, all right.",
        movieName: "Dazed and Confused",
    },
    {
        quote: "All I'm saying is that if I ever start referring to these as the best years of my life - remind me to kill myself.",
        movieName: "Dazed and Confused",
    },
    {
    ...
    {
        quote: "We met at Starbucks. Not at the same Starbucks but we saw each other at different Starbucks across the street from each other.",
        movieName: "Best In Show",
    },
    {
